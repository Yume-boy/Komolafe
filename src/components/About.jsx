  ...
  return (
    <div className='about row px-4 my-5 ' id='about'>
      <div className='col-12 col-md-8'  >
        ...
        <p data-aos="fade-right" data-aos-duration='1000'>My name is <strong>Marvellous Komolafe </strong>, and I'm a dedicated <strong>Front-end Web Developer</strong> with over a year of experience. I excel in creating remarkable web applications using React.js, Tailwind CSS, Bootstrap, and Bubble.io for no code development.</p>
        <p data-aos="fade-right" data-aos-duration='1000'>I am passionate about transforming ideas into reality and ensuring seamless functionality.From crafting beautiful,<strong> responsive designs</strong> to implementing interactive <strong>front-end features</strong>, I am committed to delivering top-quality work that meets your needs.</p>
        <p data-aos="fade-right" data-aos-duration='1000'>Let's collaborate and create something extraordinary together!</p>
      </div>
